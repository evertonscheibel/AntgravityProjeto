...
export const slaughter = {
    ...
    /** Busca escala por data (YYYY-MM-DD). */
    getByDate: (date: string) =>
...
export const slaughterClosure = {
    ...
    /** Lista todos os fechamentos (historico) */
    list: () =>
        fetchAuth(`${CLOSURE}`),
...
// Exports legados para compatibilidade temporária (migrar gradualmente para objetos nomeados acima)
export const preScheduleService = preSchedule;
export const slaughterService = slaughter;
export const slaughterClosureService = slaughterClosure;
