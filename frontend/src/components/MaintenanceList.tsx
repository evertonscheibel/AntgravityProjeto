...
export const MaintenanceList: React.FC<MaintenanceListProps> = ({ maintenances, onEdit, onDelete }) => {
    ...
    return (
        <div>
            <div style={{ marginBottom: '16px', padding: '16px', background: 'linear-gradient(135deg, #2d6a4f 0%, #1b4332 100%)', borderRadius: '12px', color: 'white' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
                                <div style={{ flex: 1 }}>
                                    ...
                                    <div style={{ fontSize: '13px', color: '#0369a1', fontWeight: '700', marginBottom: '4px' }}>
                                        {maintenance.asset?.assetId} - {maintenance.asset?.description}
                                    </div>
